...
<div class="app-content-header">
    ...
    {{--begin::Row--}}
    <div class="row">
        <div class="col-sm-6"><h3 class="mb-0">Copy Invoice</h3></div>
        <div class="col-sm-6">
        <ol class="breadcrumb float-sm-end">
            <li class="breadcrumb-item"><a href="{{ route('admin.invoices') }}">Invoices</a></li>
            <li class="breadcrumb-item active" aria-current="page">Copy Invoice</li>
        </ol>
        </div>
    </div>
    {{--end::Row--}}
    ...
    {{--begin::Row--}}
        <div class="row g-4">
            <div class="col-md-12">
                  ...
                  {{--begin::Alert--}}
                  {{--begin::Form--}}
                  <form action="{{ route('admin.save_unlinked_invoice') }}" method="post">
                    @csrf
                    {{--begin::Header--}}
                                ...
                                <div class="col-md-6 mt-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="invoice_date" id="invoice_date" value="{{ get_formatted_date($data->invoice_date, 'M d, Y') }}" aria-describedby="invoice_dateHelp" />
                                        </div>
                                        @error('invoice_date')
