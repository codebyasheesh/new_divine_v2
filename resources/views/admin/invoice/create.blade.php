    ...
    {{--begin::Row--}}
        <div class="row g-4">
            <div class="col-md-12">
                  ...
                  {{--begin::Alert--}}
                  {{--begin::Form--}}
                  <form action="{{ route('admin.save_invoice') }}" method="post">
                    @csrf
                    {{--begin::Header--}}
                        ...
                        <div class="mb-3">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" name="time_slots" value="{{$data->time_slots}}">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="therapist_id" id="therapist_id" class="form-select">
                                                ...
                                                <option value="{{$val->id}}" {{ $val->id == $data->service_provider_id ? 'selected' : '' }}>{{ $val->first_name.' '.$val->last_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="customer_name" id="customer_search" class="form-control" value="{{$data->customer_name}}">
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="customer_email" value="{{$data->customer_email}}" readonly>
                                        </div>
                                ...
                                <div class="col-md-6 mt-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="customer_mobile" value="{{$data->customer_mobile}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mt-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="invoice_date" id="invoice_date" value="{{ old('invoice_date', get_formatted_date($data->booking_date, 'M d, Y')) }}" aria-describedby="invoice_dateHelp" readonly />
                                        </div>
                                ...
                                {{-- <div class="col-md-6 mt-4">
                                    <div class="gorm-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text" id="basic-addon2"><i class="bi bi-calendar3"></i></span>
                                            <input type="text" class="form-control" name="payment_due_date" id="payment_due_date" value="{{ old('payment_due_date')?? get_formatted_date($data->booking_date, 'F d, Y') }}"
                                        aria-describedby="payment_due_dateHelp" readonly
                                        />
                                        </div>
                                ...
                                <div class="row">
                                    <table class="table table-bordered" id="services_table">
                                        ...
                                        <tbody id="services_body">
                                            @php
                                            $index = 0; $taxable_amt = 0;
                                            @endphp
                                            @foreach($data->service_details as $val)
                                            <tr>
                                                <td>
                                                    <select name="service_id[]" id="service_id_{{ $index }}" class="form-select" onchange="getServicePrice('{{$index}}');">
                                                        <option value="">Select Service</option>
                                                        @foreach($services as $service)
                                                            <option value="{{ $service->id }}" {{($service->id == $val->id)?'selected':''}}>{{ $service->service_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td>
                                                    <div id="duration_{{ $index }}">{{$val->duration.' Min'}}</div>
                                                </td>
                                                <td>1</td>
                                                <td>
                                                    <div id="row_total_div_{{$index}}">$<span id="spn_row_total_{{$index}}">{{$val->price}}</span></div>
                                                    <input type="hidden" name="row_total[]" id="row_total_{{ $index }}" value="{{$val->price}}">
                                                    <input type="hidden" name="is_taxable[]" id="is_taxable_{{ $index }}" value="{{$val->is_taxable}}">
                                                </td>
                                                <td>&nbsp;</td>
                                            </tr>
                                            @if($val->is_taxable == 1)
                                            @php 
                                            $taxable_amt += $val->price;
                                            $index++
                                            @endphp
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <input type="number" class="form-control" name="discount" id="discount" min="0" value="0" onkeyup="calculateDiscount();">
                                    </div> --}}
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden" name="subtotal" id="subtotal" value="{{$data->total_amount}}">
                                    <div class="mt-1"><span>$</span><span id="spn_sub_tot">{{number_format($data->total_amount, '2', '.')}}</span></div>
                                    </div>
                                </div>
                                {{-- <div class="row">
                                    <div class="col-7 fw-bold text-end mt-1">Discount:</div>
                                    <div class="col-5 text-end">
                                    <div class="mt-1"><span>$</span><span id="spn_discount">0</span><input type="hidden" name="discount_val" value=""></div>
                                    </div>
                                </div> --}}
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-5 text-end">
                                        @php
                                        $tax_amount = number_format($taxable_amt * ($setting->tax_value/100), 2, '.', '');
                                        @endphp
                                    <div class="mt-1"><span>$</span><span id="spn_hst">{{$tax_amount}}</span><input type="hidden" name="hst_val" value="{{$tax_amount}}"></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-7 fw-bold text-end mt-1">Grand Total:</div>
                                    <div class="col-5 text-end">
                                    <div class="mt-1"><span>$</span><span id="spn_grand_total" class="fw-bold">{{number_format($data->total_amount + $tax_amount, 2)}}</span>
                                        <input type="hidden" name="grand_total" value="{{number_format($data->total_amount + $tax_amount, 2)}}">
                                    </div>
                                    </div>
                                </div>
