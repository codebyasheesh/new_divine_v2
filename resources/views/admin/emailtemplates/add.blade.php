...
<div class="app-content">
    ...
    {{--begin::Row--}}
        <div class="row g-4">
            <div class="col-md-12">
                  {{--begin::Form--}}
                <form action="{{ route('admin.save.email.template') }}" method="post">
                @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="template_key" id="template_key" class="form-control" value="{{ old('template_key') }}" placeholder="Template Key" readonly>
                                    </div>
                                    @error('template_key')
                                    <div class="text-danger">{{$message}}</div>
                                    @enderror
