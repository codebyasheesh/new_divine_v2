        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-daterange input-group" id="datepicker">
                                        ...
                                        <button class="btn btn-sm btn-primary" id="appointmentDateFilter" data-bs-toggletip="tooltip" data-bs-title="Date Range Filter" role="button"><i class="bi bi-search"></i> Filter</button>
                                    </div>
                    ...
                    {{-- /.card-header --}}
                    <div class="card-body">
                        <table class="table table-striped table-sm" id="appointment-table">
                            <thead>
