...
<table class="header-table">
    <tr>
        <td style="width: 25%;">
            <img src="{{ public_path('admin_assets/assets/img/divine-touch-logo2.png') }}" width="140">
        </td>
        ...
        <td style="width: 40%;" class="text-right">
            ...
            <div>
                70 Twistleton St<br>
                Caledon, ON L7C 4B5<br>
                Telephone: +1 905-996-2700<br>
...
<table class="items-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $val->duration }}</td>
            <td>1</td>
            <td>${{ number_format($data->ser_price[$key], 2) }}</td>
        </tr>
        @endforeach
    </tbody>
</table>
...
<table class="totals-table">
    ...
    <tr>
        <td></td>
        <td class="fw-bold" style="border-top: 1px solid #999;">&nbsp;</td>
        <td class="text-right fw-bold" style="border-top: 1px solid #999;">
            <a href="{{ $payment_link }}" class="pay-now-btn">Pay Now</a>
        </td>
    </tr>
</table>
